	   ...
	   <div class="d-flex" id="wrapper" data-aos="fade-right">
			...
			<div class="border-right" id="sidebar-wrapper">
				<div class="sidebar-heading text-center">
					<img src="/images/admin.png" alt="logo" class="my-4" style="width: 120px">
				</div>
				<div class="list-group list-group-flush">
					...
					<a href="{{route('product-gallery.index')}}" class="list-group-item list-group-item-action {{ (request()->is('admin/gallery*')) ? 'active' : '' }}">
					Gallery
					</a>
